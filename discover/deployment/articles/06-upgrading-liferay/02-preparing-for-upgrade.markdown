...
-   [7.0 portal properties](@platform-ref@/7.0/propertiesdoc/portal.properties.html)
-   [7.1 portal properties](@platform-ref@/7.1/propertiesdoc/portal.properties.html)
...
**Important**: Once you have installed @product@, **DON'T START IT!** Prior to
@product@ 7.0, once you prepared your system for an upgrade, the upgrade process
ran when you started the new version for the first time. Now @product-ver@ ships
with an upgrade tool (described in the next article) that you must use to
